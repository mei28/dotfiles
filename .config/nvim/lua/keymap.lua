...
vim.api
    .nvim_set_keymap('i', '<C-f>', '<Right>', {noremap = true, silent = true})
...
vim.api
    .nvim_set_keymap('c', '<C-f>', '<Right>', {noremap = true, silent = true})
...
vim.api
    .nvim_set_keymap('n', '<C-f>', '<Right>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<C-b>', '<Left>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<C-a>', '<Home>', {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<C-p>', ':bnext<CR>',
                        {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<C-n>', ':bprev<CR>',
                        {noremap = true, silent = true})
...
vim.api.nvim_set_keymap('n', '<Leader>l', '<C-w>l',
                        {noremap = true, silent = true})
vim.api.nvim_set_keymap('n', '<Leader>hh', '<C-w>h',
                        {noremap = true, silent = true})
...
vim.api.nvim_set_keymap('i', '<C-v>', '<C-r><C-o>0',
                        {noremap = true, silent = true, expr = true})
vim.api.nvim_set_keymap('c', '<C-v>', '<C-r><C-o>0',
                        {noremap = true, silent = true, expr = true})
