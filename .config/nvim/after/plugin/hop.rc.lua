...
vim.api.nvim_set_keymap('n', '<leader><leader>f', "<cmd>lua require'hop'.hint_words({hint_offset = 1 })<cr>", {})
vim.api.nvim_set_keymap('n', '<leader><leader>l', "<cmd>lua require'hop'.hint_lines({hint_offset = 1 })<cr>", {})
